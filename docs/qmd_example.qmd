...
![Figure 1: Horse populations for all provinces in Canada from 1906 - 1972.](../results/horse_pops_plot.png){#fig-1 width=70%}
...
We present the standard deviations in @{tbl-dev}.
...
Additionally, note that in @{tbl-dev} we consider the sample standard deviation of the number of horses during the same time span as @{fig-1}.

![Figure 2: Horse populations for the province with the largest standard deviation](../results/horse_pops_plot_largest_sd.png){#fig-2 width=70%}
